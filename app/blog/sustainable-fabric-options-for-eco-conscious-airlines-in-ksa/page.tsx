...
export const generateMetadata = (): Metadata => {
  return {
    title: 'Sustainable Fabric Options For Eco Conscious Airlines In Ksa | UniformSA',
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <nav className="mb-8 flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>&gt;</span>
            <span className="text-gray-700 dark:text-white">SLUG_Sustainable Fabric Options For Eco Conscious Airlines In Ksa</span>
          </nav>
          ...
          <div className="mb-10">
            <Image
              ...
              alt="Sustainable Fabric Options For Eco Conscious Airlines In Ksa"
              width={1000}
              height={600}
