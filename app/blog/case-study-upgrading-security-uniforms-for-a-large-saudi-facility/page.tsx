        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul><li>59 mixed-use towers and facilities</li>
                ...
                <li>Sophisticated infrastructure requiring comprehensive security protocols</li></ul>
              <p>
              ...
              <ul><li><strong>Extreme temperature variations:</strong> The existing uniforms performed poorly in Riyadh's climate, where temperatures regularly exceed 45°C in summer months while requiring adaptability for air-conditioned environments</li>
                ...
                <li><strong>Transition requirements:</strong> Staff regularly moved between indoor and outdoor environments, creating thermal regulation challenges</li></ul>

              <h3>Operational Challenges</h3>
              <ul><li><strong>Role differentiation:</strong> The existing uniform system inadequately distinguished between specialized security functions</li>
                ...
                <li><strong>Inconsistent appearance:</strong> Varied replacement cycles created visual inconsistencies across the security force</li></ul>

              <h3>Strategic Challenges</h3>
              <ul><li><strong>Brand alignment:</strong> Security presentation needed updating to align with KAFD's premium international positioning</li>
                ...
                <li><strong>Vision 2030 compatibility:</strong> The security presentation needed to reflect Saudi Arabia's modernization initiatives</li></ul>
              ...
              <ul><li><strong>Staff consultations:</strong> Structured interviews and surveys with security personnel across all roles and ranks</li>
                ...
                <li><strong>Stakeholder input:</strong> Feedback from facility tenants, management, and visitors regarding security presence</li></ul>
              ...
              <ul><li><strong>Role-based design system:</strong> Five distinct uniform variants corresponding to different security functions</li>
                ...
                <li><strong>Visual hierarchy:</strong> Clear rank indicators and role signifiers through color coding, insignia, and design elements</li></ul>
              ...
              <ul><li><strong>Primary fabrics:</strong> Specialized poly-cotton blends (65/35) with mechanical stretch and moisture-wicking properties</li>
                ...
                <li><strong>Hardware upgrades:</strong> Metal components with enhanced corrosion resistance for the local climate</li></ul>
              ...
              <ul><li><strong>Pilot testing:</strong> Initial deployment with 45 officers across varied roles for field-testing and refinement</li>
                ...
                <li><strong>Feedback loops:</strong> Continuous assessment and minor adjustments throughout the implementation</li></ul>

              <h3>Change Management Approach</h3>
              <p>
                Recognizing the cultural significance of uniform changes, the project incorporated:
              </p>
              <ul><li><strong>Staff ambassadors:</strong> Department representatives involved in the design process to build organizational buy-in</li>
                ...
                <li><strong>Recognition elements:</strong> Incorporation of service tenure indicators to acknowledge experienced personnel</li></ul>
              ...
              <ul><li><strong>Thermal comfort:</strong> Reports of temperature-related discomfort decreased from 64% to 21%</li>
                ...
                <li><strong>Professional pride:</strong> 84% of officers reported enhanced professional identity and workplace satisfaction</li></ul>

              <h3>Operational Improvements</h3>
              <ul><li><strong>Role recognition:</strong> Visitor ability to distinguish security roles increased from 53% to 92%</li>
                ...
                <li><strong>Consistent presentation:</strong> Visual inconsistency incidents reduced by 76%</li></ul>

              <h3>Financial and Strategic Outcomes</h3>
              <ul><li><strong>Initial investment:</strong> 38% higher per-officer cost compared to previous uniform program</li>
                ...
                <li><strong>Brand alignment:</strong> Executive assessment confirmed enhanced alignment with KAFD's premium positioning</li></ul>
              ...
              <ul><li><strong>Climate-first design:</strong> Saudi Arabia's environment must be the primary consideration in material selection and construction methodologies</li>
                ...
                <li><strong>Identity reinforcement:</strong> Uniform programs should reinforce organizational values and positioning</li></ul>
