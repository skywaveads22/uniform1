...
export const generateMetadata = (): Metadata => {
  return {
    title: 'High Visibility Elements For Night Patrols And Low Light Conditions In Saudi Arabia | UniformSA',
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-10">
            <Image
              ...
              alt="High Visibility Elements For Night Patrols And Low Light Conditions In Saudi Arabia"
              width={1000}
              height={600}
