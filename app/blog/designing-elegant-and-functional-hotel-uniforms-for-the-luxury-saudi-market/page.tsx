...
export const generateMetadata = (): Metadata => {
  return {
    title: 'Designing Elegant And Functional Hotel Uniforms For The Luxury Saudi Market | UniformSA',
    description: 'Learn more about uniforms and professional attire in Saudi Arabia.',
    openGraph: {
      images: ['/images/hospitality/boutique_hotel_staff_uniforms.jpeg'],
    },
  }
}
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <nav className="mb-8 flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>&gt;</span>
            <span className="text-gray-700 dark:text-white">SLUG_Designing Elegant And Functional Hotel Uniforms For The Luxury Saudi Market</span>
          </nav>
          ...
          <div className="mb-10">
            <Image
              ...
              alt="Designing Elegant And Functional Hotel Uniforms For The Luxury Saudi Market"
              width={1000}
              height={600}
