...
export const generateMetadata = (): Metadata => {
  return {
    title: 'Fire Resistant Materials For Aviation Uniforms Safety Standards In Saudi Operations | UniformSA',
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <nav className="mb-8 flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>&gt;</span>
            <span className="text-gray-700 dark:text-white">SLUG_Fire Resistant Materials For Aviation Uniforms Safety Standards In Saudi Operations</span>
          </nav>
          ...
          <div className="mb-10">
            <h1 className="mb-4 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
              Fire Resistant Materials For Aviation Uniforms Safety Standards In Saudi Operations
            </h1>
