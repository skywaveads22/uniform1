        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul><li><strong>Flight Crew Members:</strong> Pilots, co-pilots, and flight engineers on commercial and private aircraft</li>
                ...
                <li><strong>Airport Service Providers:</strong> Personnel providing services within airport premises</li></ul>
              ...
              <ul><li><strong>Design Submission:</strong> Detailed uniform specifications including materials, colors, and construction details</li>
                ...
                <li><strong>Ongoing Compliance Monitoring:</strong> Regular audits and inspections to ensure continued adherence</li></ul>
              ...
              <ul><li><strong>Flame Resistance Standards:</strong> Materials must meet or exceed international flame resistance requirements</li>
                ...
                <li><strong>Chemical Resistance:</strong> Protection against common aviation chemicals and fluids</li></ul>
              ...
              <ul><li><strong>Tensile Strength:</strong> Ability to withstand operational stress and equipment weight</li>
                ...
                <li><strong>Environmental Resistance:</strong> Performance in extreme temperatures and humidity conditions</li></ul>
              ...
              <ul><li><strong>Color Specifications:</strong> Approved color palettes that maintain professional appearance and safety visibility</li>
                ...
                <li><strong>Seasonal Adaptations:</strong> Approved variations for different climate conditions and operational environments</li></ul>
              ...
              <ul><li><strong>Company Identification:</strong> Clear display of airline or operator name in Arabic and English</li>
                ...
                <li><strong>Emergency Contact Information:</strong> Accessible contact details for emergency situations</li></ul>
              ...
              <ul><li><strong>Appropriate Coverage:</strong> Designs that provide modest coverage for arms, legs, and neckline</li>
                ...
                <li><strong>Hijab Integration:</strong> Accommodation for religious head coverings where applicable</li></ul>
              ...
              <ul><li><strong>Prayer-Friendly Design:</strong> Clothing that accommodates prayer positions and movements</li>
                ...
                <li><strong>Religious Symbol Display:</strong> Appropriate incorporation of Islamic symbols where required</li></ul>
              ...
              <ul><li><strong>Command Authority Indicators:</strong> Distinctive elements that clearly identify command structure</li>
                ...
                <li><strong>Multi-Climate Capability:</strong> Adaptability for international route operations</li></ul>
              ...
              <ul><li><strong>Service Functionality:</strong> Designs that facilitate passenger service activities</li>
                ...
                <li><strong>Comfort and Mobility:</strong> Functionality for extended duty periods and physical demands</li></ul>
              ...
              <ul><li><strong>High-Visibility Requirements:</strong> Reflective materials and bright colors for airport safety</li>
                ...
                <li><strong>Role-Specific Adaptations:</strong> Specialized features for different ground operation functions</li></ul>
              ...
              <ul><li><strong>Application Submission:</strong> Formal application with complete uniform specifications</li>
                ...
                <li><strong>Approval Certification:</strong> Formal certification authorizing uniform implementation</li></ul>
              ...
              <ul><li><strong>Regular Inspections:</strong> Periodic GACA audits of uniform implementation and maintenance</li>
                ...
                <li><strong>Renewal Procedures:</strong> Periodic renewal of uniform approvals and certifications</li></ul>
              ...
              <ul><li><strong>Approved Supplier Networks:</strong> Working with manufacturers familiar with GACA requirements</li>
                ...
                <li><strong>Contingency Planning:</strong> Backup suppliers and emergency procurement procedures</li></ul>
              ...
              <ul><li><strong>Compliance Training:</strong> Education on GACA uniform requirements and standards</li>
                ...
                <li><strong>Ongoing Updates:</strong> Regular training on regulatory changes and updates</li></ul>
              ...
              <ul><li><strong>Warning Notices:</strong> Initial notifications for minor compliance issues</li>
                ...
                <li><strong>Certificate Revocation:</strong> Permanent loss of aviation operating authority for severe non-compliance</li></ul>
              ...
              <ul><li><strong>Immediate Remediation:</strong> Urgent correction of safety-related compliance issues</li>
                ...
                <li><strong>Preventive Measures:</strong> Implementation of systems to prevent future violations</li></ul>
              ...
              <ul><li><strong>Global Standards Compliance:</strong> Adherence to international aviation uniform standards</li>
                ...
                <li><strong>Regulatory Cooperation:</strong> Coordination with international aviation authorities</li></ul>
              ...
              <ul><li><strong>GCC Harmonization:</strong> Alignment with Gulf Cooperation Council aviation standards</li>
                ...
                <li><strong>Joint Training Programs:</strong> Collaborative training and certification initiatives</li></ul>
              ...
              <ul><li><strong>Smart Uniform Standards:</strong> Regulations for technology-integrated uniforms</li>
                ...
                <li><strong>Data Security:</strong> Requirements for protecting personal and operational data</li></ul>
              ...
              <ul><li><strong>Sustainable Materials:</strong> Preferences for environmentally responsible fabrics</li>
                ...
                <li><strong>Carbon Footprint Reduction:</strong> Requirements for minimizing environmental impact</li></ul>
