...
export const generateMetadata = (): Metadata => {
  return {
    title: 'Uniform Needs For Specific Industries Construction Manufacturing Oil Gas Logistics In Ksa | UniformSA',
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-10">
            <Image
              ...
              alt="Uniform Needs For Specific Industries Construction Manufacturing Oil Gas Logistics In Ksa"
              width={1000}
              height={600}
